---
globs:
  - "**/*slider*.{js,ts,jsx,tsx,astro,vue}"
  - "**/wip/slider/**"
  - "**/components/**/Slider*.{js,ts,jsx,tsx,astro,vue}"
alwaysApply: false
description: Rules for using the smooothy slider API - initialization, configuration, callbacks, and best practices
---
